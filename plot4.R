...
##Construct fourth plot and save it to a PNG file with 
##a width of 480 pixels and a height of 480 pixels called 'plot4.png'.
png(file= "plot4.png", width=480, height=480)

par(mfrow=c(2,2))

with(data_base_1, {plot(DT_done, Global_active_power,type='l',xlab="", ylab = 'Global Active Power')
        plot(DT_done, Voltage,type='l',xlab="datatime", ylab="Voltage")
        plot(DT_done, Sub_metering_1, type="l", col="black", ylab ="Energy sub metering", xlab="")
        lines(DT_done, Sub_metering_2, type="l", col="red")
        lines(DT_done, Sub_metering_3, type="l", col="blue")
        legend("topright", lwd = 1,  bty="n",col = c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"))
        plot(DT_done, Global_reactive_power,type='l',xlab="datatime", ylab="Global_reactive_power")})
dev.off() 
