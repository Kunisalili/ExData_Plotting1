...
##Construct third plot and save it to a PNG file with 
##a width of 480 pixels and a height of 480 pixels called 'plot3.png'.
png(file="plot3.png", width=480, height=480)

with (data_base_1, {plot(DT_done, Sub_metering_1, type="l", col="black", ylab ="Energy sub metering", xlab="")
